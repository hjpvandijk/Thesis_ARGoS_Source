/**
 * @file <argos3/plugins/robots/pi-puck/simulator/pipuck_battery_default_sensor.cpp>
 *
...
#include "pipuck_battery_default_sensor.h"
...
namespace argos {
   ...
   CPiPuckBatteryDefaultSensor::CPiPuckBatteryDefaultSensor() :
   ...
   void CPiPuckBatteryDefaultSensor::SetRobot(CComposableEntity& c_entity) {
      try {
          m_pcEmbodiedEntity = &(c_entity.GetComponent<CEmbodiedEntity>("body"));
          m_pcBatteryEntity = &(c_entity.GetComponent<CPiPuckBatteryEquippedEntity>("pipuck_battery"));
   ...
   void CPiPuckBatteryDefaultSensor::Init(TConfigurationNode& t_tree) {
      try {
   ...
   void CPiPuckBatteryDefaultSensor::Update() {
   ...
   void CPiPuckBatteryDefaultSensor::Reset() {
      /* TODO */
   }
   ...
   REGISTER_SENSOR(CPiPuckBatteryDefaultSensor,
                   "pipuck_battery", "default",
                   "Daniel H. Stolfi based on the Adhavan Jayabalan's work",
                   "1.0",
                   "A battery level sensor for Pi-Puck robots.",

                   "This sensor returns the current battery level of a pipuck robot. In\n"
                   ...
                   "      <sensors>\n"
                   "        ...\n"
                   "        <pipuck_battery implementation=\"default\" />\n"
                   "        ...\n"
                   "      </sensors>\n"
                   "      ...\n"
                   "    </my_controller>\n"
