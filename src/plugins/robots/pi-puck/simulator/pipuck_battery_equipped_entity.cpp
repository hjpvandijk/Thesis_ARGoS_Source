...
namespace argos {
   ...
   CPiPuckBatteryEquippedEntity::CPiPuckBatteryEquippedEntity(CComposableEntity *pc_parent) :
      CEntity(pc_parent),
      m_fFullCharge(1.0),
      m_fAvailableCharge(m_fFullCharge),
      m_pcDischargeModel(nullptr) {
      SetDischargeModel(new CPiPuckBatteryDischargeModelSimple());
      Disable();
   }
   ...
   CPiPuckBatteryEquippedEntity::CPiPuckBatteryEquippedEntity(CComposableEntity *pc_parent,
                                                  ...
                                                  CPiPuckBatteryDischargeModel* pc_discharge_model,
                                                  Real f_start_charge,
                                                  Real f_full_charge) :
   ...
   CPiPuckBatteryEquippedEntity::~CPiPuckBatteryEquippedEntity() {
   ...
   void CPiPuckBatteryEquippedEntity::Init(TConfigurationNode& t_tree) {
      try {
         CEntity::Init(t_tree);
   ...
   void CPiPuckBatteryEquippedEntity::Update() {
   ...
   void CPiPuckBatteryEquippedEntity::SetDischargeModel(CPiPuckBatteryDischargeModel* pc_model) {
   ...
   void CPiPuckBatteryEquippedEntity::SetDischargeModel(const std::string& str_model) {
       if(m_pcDischargeModel) delete m_pcDischargeModel;
      if(str_model != "") {
   ...
   CPiPuckBatteryDischargeModel::CPiPuckBatteryDischargeModel() :
      m_pcBattery(nullptr) {
   }
   ...
   void CPiPuckBatteryDischargeModel::SetBattery(CPiPuckBatteryEquippedEntity* pc_battery) {
   ...
   void CPiPuckBatteryDischargeModelCubic::Init(TConfigurationNode& t_tree) {
   }

   /****************************************/
   /****************************************/

   void CPiPuckBatteryDischargeModelCubic::SetBattery(CPiPuckBatteryEquippedEntity* pc_battery) {
      try {
         /* Execute default logic */
         CPiPuckBatteryDischargeModel::SetBattery(pc_battery);
   ...
   Real CPiPuckBatteryDischargeModelCubic::CubicRoot(const Real a, const Real b, const Real c, const Real d, const Real y) {
     Real new_d = d - y;
     Real d0 = b*b - 3*a*c;
   ...
   void CPiPuckBatteryDischargeModelCubic::operator()() {
   ...
   void CPiPuckBatteryDischargeModelApprox::Init(TConfigurationNode& t_tree) {
   }

   /****************************************/
   /****************************************/

   void CPiPuckBatteryDischargeModelApprox::SetBattery(CPiPuckBatteryEquippedEntity* pc_battery) {
      try {
         /* Execute default logic */
         CPiPuckBatteryDischargeModel::SetBattery(pc_battery);
         /* Get a hold of the body and anchor of the entity that contains the battery */
   ...
   void CPiPuckBatteryDischargeModelApprox::operator()() {
      if(m_pcBattery->GetAvailableCharge() > 0.0) {
         /* Calculate delta position */
         Real fDeltaPos = Distance(m_psAnchor->Position,
                                   m_cOldPosition);
   ...
   void CPiPuckBatteryDischargeModelLinear::Init(TConfigurationNode& t_tree) {
   }

   /****************************************/
   /****************************************/

   void CPiPuckBatteryDischargeModelLinear::SetBattery(CPiPuckBatteryEquippedEntity* pc_battery) {
      try {
         /* Execute default logic */
         CPiPuckBatteryDischargeModel::SetBattery(pc_battery);
         /* Get a hold of the body and anchor of the entity that contains the battery */
   ...
   void CPiPuckBatteryDischargeModelLinear::operator()() {
      if(m_pcBattery->GetAvailableCharge() > 0.0) {
         /* Calculate delta position */
         Real fDeltaPos = Distance(m_psAnchor->Position,
                                   m_cOldPosition);
   ...
   void CPiPuckBatteryDischargeModelSimple::Init(TConfigurationNode& t_tree) {
   }

   /****************************************/
   /****************************************/

   void CPiPuckBatteryDischargeModelSimple::SetBattery(CPiPuckBatteryEquippedEntity* pc_battery) {
      try {
         /* Execute default logic */
         CPiPuckBatteryDischargeModel::SetBattery(pc_battery);
         /* Get a hold of the body and anchor of the entity that contains the battery */
   ...
   void CPiPuckBatteryDischargeModelSimple::operator()() {
      if(m_pcBattery->GetAvailableCharge() > 0.0) {
         /* Calculate delta position */
         Real fDeltaPos = Distance(m_psAnchor->Position,
                                   m_cOldPosition);
   ...
   REGISTER_STANDARD_SPACE_OPERATIONS_ON_ENTITY(CPiPuckBatteryEquippedEntity);
   REGISTER_BATTERY_DISCHARGE_MODEL(CPiPuckBatteryDischargeModelCubic, "cubic");
   REGISTER_BATTERY_DISCHARGE_MODEL(CPiPuckBatteryDischargeModelApprox, "approx");
   REGISTER_BATTERY_DISCHARGE_MODEL(CPiPuckBatteryDischargeModelLinear, "linear");
   REGISTER_BATTERY_DISCHARGE_MODEL(CPiPuckBatteryDischargeModelSimple, "simple");
