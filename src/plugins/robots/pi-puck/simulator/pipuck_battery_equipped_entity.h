/**
 * @file <argos3/plugins/robots/pi-puck/battery_equipped_entity.h>
 *
...
#ifndef PIPUCK_BATTERY_EQUIPPED_ENTITY_H
#define PIPUCK_BATTERY_EQUIPPED_ENTITY_H

namespace argos {
   class CPiPuckBatteryEquippedEntity;
   class CPiPuckBatteryDischargeModel;
}
...
namespace argos {
    ...
    */
   class CPiPuckBatteryEquippedEntity : public CEntity {
   ...
   public:
      ...
      CPiPuckBatteryEquippedEntity(CComposableEntity* pc_parent);

      CPiPuckBatteryEquippedEntity(CComposableEntity *pc_parent,
                             const std::string& str_id,
                             CPiPuckBatteryDischargeModel* pc_discharge_model = NULL,
      ...
      virtual ~CPiPuckBatteryEquippedEntity();

      virtual void Init(TConfigurationNode& t_tree);

      virtual std::string GetTypeDescription() const {
         return "pipuck_battery";
      }
      ...
      void SetDischargeModel(CPiPuckBatteryDischargeModel* pc_model);
   ...
   protected:
      ...
      /** Discharge model */
      CPiPuckBatteryDischargeModel* m_pcDischargeModel;
   };
    ...
    * time.
    */
   class CPiPuckBatteryDischargeModel : public CBaseConfigurableResource {
         
   public:

      CPiPuckBatteryDischargeModel();

      virtual ~CPiPuckBatteryDischargeModel();
      ...
      virtual void SetBattery(CPiPuckBatteryEquippedEntity* pc_battery);
         
      virtual void operator()() = 0;
         
   protected:
      Real MAX_SPEED = 0.15;  // 15 cm/s
      CPiPuckBatteryEquippedEntity* m_pcBattery;
   };
    ...
    */
   typedef CFactory<CPiPuckBatteryDischargeModel> TFactoryBatteryDischargeModel;
   
#define REGISTER_BATTERY_DISCHARGE_MODEL(CLASSNAME, LABEL)  \
   REGISTER_SYMBOL(CPiPuckBatteryDischargeModel,                  \
                   CLASSNAME,                               \
                   LABEL,                                   \
                   "undefined",                             \
                   "undefined",                             \
    ...
    */
   class CPiPuckBatteryDischargeModelCubic : public CPiPuckBatteryDischargeModel {
      
   public:
      
      CPiPuckBatteryDischargeModelCubic() :
         m_psAnchor(NULL) {}
    ...
    */
   class CPiPuckBatteryDischargeModelApprox : public CPiPuckBatteryDischargeModel {

   public:

      CPiPuckBatteryDischargeModelApprox() :
         m_psAnchor(NULL),
         m_fDelta(1e-5),
         m_fPosFactor(1e-3) {}
    ...
    */
   class CPiPuckBatteryDischargeModelLinear : public CPiPuckBatteryDischargeModel {

   public:

      CPiPuckBatteryDischargeModelLinear() :
         m_psAnchor(NULL) {}
    ...
    */
   class CPiPuckBatteryDischargeModelSimple : public CPiPuckBatteryDischargeModel {

   public:

      CPiPuckBatteryDischargeModelSimple() :
         m_psAnchor(NULL) {}
